...
# Ekstensi file frontend yang boleh dilayani (bukan source Python / DB)
...
# --- Serve frontend dari backend (satu URL: http://IP:5000/) ---
@app.route('/')
def serve_index():
...
if __name__ == '__main__':
    # host='0.0.0.0' = semua interface (LAN). USE_HTTPS=1 = HTTPS adhoc agar kamera jalan di http://IP (bukan hanya localhost).
    ...
    if use_https:
        try:
            import cryptography  # noqa: F401 — Werkzeug butuh ini untuk ssl_context='adhoc'
        except ImportError:
